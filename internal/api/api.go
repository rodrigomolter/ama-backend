...
func NewHandler(q *pgstore.Queries) http.Handler {
	...
	r.Use(cors.Handler(cors.Options{
		AllowedOrigins:   []string{"https://*", "http://*"}, // CHANGE TO YOUR DOMAIN IN PRODUCTION
...
func (h apiHandler) handleGetRooms(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to get rooms from db", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to insert message into db", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessages(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to get room messages from db", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		slog.Error("failed to get message from db", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleReactionToMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to persist reaction into db", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleMarkMessageAsAnswered(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("failed to persist message as answered", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
